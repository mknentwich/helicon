...
interface MetaService {
    ...
    fun updateState(
        @Parameter(description = "the state to update") @RequestBody state: StateDto,
        @Parameter(description = "id of the state") @PathVariable id: Long,
    ...
    fun updateZone(
        @Parameter(description = "the zone to update") @RequestBody zone: ZoneDto,
        @Parameter(description = "id of the zone") @PathVariable id: Long,
        @RequestHeader(name = "Authorization") jwt: String
