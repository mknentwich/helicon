...
interface AccountService {
    ...
    fun updateAccount(@Parameter(description = "the user") @RequestBody user: AccountDto,
                      @Parameter(description = "the username") @PathVariable username: String): ResponseEntity<AccountDto>
