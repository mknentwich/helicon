...
Currently, Helicon does not have a linter which automatically formats the code before every commit.
If you know a working solution feel free to open an issue for that.
